...
public class test11 extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
     ...
     list = new ArrayList<>();
        ...
        quit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(test11.this, result11.class);
    ...
    private void setquestion()  {
        loadingdialog.show();
        reference = FirebaseDatabase.getInstance().getReference("Test").child("Correct form of verbs").child("Exercise 1");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (list.size()>0){
                    ...
                    finish();
                    Toast.makeText(test11.this,"no ques",Toast.LENGTH_SHORT).show();
                }
