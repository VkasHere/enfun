...
import com.example.summitclasses.Fragments.explorefrg.topichelperclass.passiveadapter;
...
public class passive extends AppCompatActivity {
    ...
    private void topicrv1data() {
        ...
        adapter= new passiveadapter(featuredlocation);
