...
import com.example.summitclasses.Fragments.explorefrg.rv1.narrationfull.test11;
import com.example.summitclasses.R;

import java.util.ArrayList;

public class narrationadapter extends RecyclerView.Adapter<narrationadapter.viewholder> {
    ArrayList<tpchelperclass> featuredlocations;
    public narrationadapter(ArrayList<tpchelperclass> featuredlocations) {
    ...
    public viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        narrationadapter.viewholder featuredviewholder = new narrationadapter.viewholder(view);
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        intent =  new Intent(context, DtoIRules.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
                    case 2:
                        intent =  new Intent(context, Imperative.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
                    case 3:
                        intent =  new Intent(context, optative.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
                    case 4:
                        intent =  new Intent(context, Exclamatory.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
                    case 5:
                        ...
                        break;
                    case 6:
                        intent =  new Intent(context, com.example.summitclasses.Fragments.explorefrg.rv1.narrationfull.Exercise2.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
                    case 7:
                        intent =  new Intent(context, com.example.summitclasses.Fragments.explorefrg.rv1.narrationfull.Exercise3.class);
                        intent.putExtra("ttl",helperclass1.getTopicnm());
                        context.startActivity(intent);
                        break;
